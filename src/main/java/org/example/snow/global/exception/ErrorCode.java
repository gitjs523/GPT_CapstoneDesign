...
public enum ErrorCode {
    ...
    INVALID_QUIZ_TYPE(HttpStatus.BAD_REQUEST, "AI_009", "문제 유형은 객관식, 단답형, 서술형 중 하나여야 합니다."),
    QUIZ_COUNT_LIMIT_EXCEEDED(HttpStatus.CONFLICT, "AI_010", "요청한 문제 수가 생성 가능한 최대치를 초과했습니다. 노트북 내 분석 완료 문서의 Section 수 이하로 요청해주세요."),
